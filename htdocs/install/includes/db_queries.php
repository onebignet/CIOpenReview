 ...
 * CIOpenReview
 *
 * An Open Source Review Site Script base on the abandoned OpenReviewScript
 *
 * @filename    db_queries.php
 * @package        CIOpenReview
 * @author        JaymZZZ
 * @date    8/21/2015
 * @time    12:55 PM
 * @copyright           Copyright (c) 2014-2015 MindBrite.com , Portions Copyright (c) 2011-2012, OpenReviewScript.org
 * @license        This file is part of CIOpenReview with portions used from OpenReviewScript - free software licensed under the GNU General Public License version 2 - http://OpenReviewScript.org/license
 * @link        http://mindbrite.com/ciopenreview
 */
// ------------------------------------------------------------------------
//
...
`id`      INT(12)                 NOT NULL,
  ...
  COLLATE = utf8_unicode_ci;",
	...
	"ALTER TABLE `logs` MODIFY `id` INT(12) NOT NULL AUTO_INCREMENT;",
...
`id`        INT(12)                 NOT NULL,
  ...
  DEFAULT CHARSET = utf8
  COLLATE = utf8_unicode_ci;",
	"ALTER TABLE `hits` ADD PRIMARY KEY(`id`), ADD KEY `review_id` (`review_id`), ADD KEY `remote_ip` (`remote_ip`);",
	"ALTER TABLE `hits` MODIFY `id` INT(12) NOT NULL AUTO_INCREMENT;",
