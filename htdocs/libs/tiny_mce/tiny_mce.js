(function (d) {
    ...
    var b = {
        majorVersion: "3", minorVersion: "4.4", releaseDate: "2011-08-04", _init: function () {
...
tinymce.create("tinymce.util.Dispatcher", {
    scope: null, listeners: null, Dispatcher: function (a) {
        this.scope = a || this;
        this.listeners = []
    }, add: function (a, b) {
    ...
    b.html.DomParser = function (g, h) {
        ...
        f.parse = function (v, m) {
            ...
            n = new b.html.SaxParser({
                validate: y, fix_self_closing: !y, cdata: function (l) {
        ...
        function b(m, v) {
            ...
            if (a.isIE6) {
                ...
                if (o.host == r.hostname && o.port == r.port && (o.protocol + ":") == r.protocol && o.protocol.toLowerCase() != "file") {
                    a.util.XHR.send({
                        url: a._addVer(o.getURI()), success: function (y) {
    ...
    e.create("tinymce.ui.DropMenu:tinymce.ui.Menu", {
        DropMenu: function (h, g) {
            ...
            g.keyboardNav = new e.ui.KeyboardNavigation({
                root: "menu_" + g.id, items: h, onCancel: function () {
                    g.hideMenu()
                }, enableUpDown: true
            });
            i.focus()
...
(function (d) {
    ...
    d.create("tinymce.ui.ListBox:tinymce.ui.Control", {
        ListBox: function (i, h, f) {
            ...
            f.add({
                title: g.settings.title, "class": "mceMenuItemTitle", onclick: function () {
            ...
            e(g.items, function (h) {
                if (h.value === undefined) {
                    f.add({
                        title: h.title, "class": "mceMenuItemTitle", onclick: function () {
                            if (g.settings.onselect("") !== false) {
                                g.select("")
                            }
                        }
    ...
    d.create("tinymce.ui.ColorSplitButton:tinymce.ui.SplitButton", {
        ColorSplitButton: function (i, h, f) {
            ...
            new d.ui.KeyboardNavigation({
                root: p.id + "_menu", items: c.select("a", p.id + "_menu"), onCancel: function () {
                    p.hideMenu();
                    p.focus()
                }
            });
    ...
    b.create("tinymce.ui.ToolbarGroup:tinymce.ui.Container", {
        renderHTML: function () {
            ...
            f.keyNav = new b.ui.KeyboardNavigation({
                root: f.id, items: e, onCancel: function () {
                    f.editor.focus()
...
(function (j) {
    ...
    j.EditorManager = d(j, {
        editors: [], i18n: {}, activeEditor: null, init: function (q) {
    ...
    m.create("tinymce.Editor", {
        Editor: function (r, q) {
            ...
            q.formatter.register({
                ...
                alignfull: [{selector: "p,h1,h2,h3,h4,h5,h6,td,th,div,ul,ol,li", styles: {textAlign: "justify"}}],
...
(function (b) {
    ...
    b.UndoManager = function (f) {
        ...
        return d = {
            typing: false, onAdd: new a(d), onUndo: new a(d), onRedo: new a(d), beforeChange: function () {
