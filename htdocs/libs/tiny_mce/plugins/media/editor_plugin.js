    ...
    tinymce.create("tinymce.plugins.MediaPlugin", {
        init: function (n, j) {
            ...
            if (this.editor.settings.media_use_script) {
                ...
                w = new b("#text", 3);
                w.value = "write" + p.name + "(" + g.serialize(tinymce.extend(E.params, {
                        width: x.attr("width"),
            ...
            if (p.name === "Audio" && E.video.sources[0]) {
                D = new b("audio", 1).attr(tinymce.extend({
                    id: x.attr("id"),
                    width: x.attr("width"),
                    height: x.attr("height"),
                    style: z
            ...
            G.attr({
                ...
                style: B,
                width: w || (y.name == "audio" ? "300" : "320"),
                height: t || (y.name == "audio" ? "32" : "240"),
