    ...
    e.create("tinymce.themes.AdvancedTheme", {
                ...
                if (o) {
                    l.progressTimer = setTimeout(function () {
                        ...
                        d.add(s, "div", {
                            id: t + "_blocker",
                            "class": "mceBlocker",
                            style: {width: p.clientWidth + 2, height: p.clientHeight + 2}
                        });
                        d.add(s, "div", {
                            id: t + "_progress",
                            "class": "mceProgress",
                            style: {left: p.clientWidth / 2, top: p.clientHeight / 2}
                        })
                    }, r || 0)
                } else {
                    d.remove(t + "_blocker");
        ...
        _createStyleSelect: function (m) {
            ...
            l = j.createListBox("styleselect", {
                title: "advanced.style_select", onselect: function (o) {
                    var p, n = [];
        ...
        _createFontSelect: function () {
            ...
            k = i.controlManager.createListBox("fontselect", {
                title: "advanced.fontdefault", onselect: function (l) {
        ...
        _createFontSizeSelect: function () {
            ...
            n = k.controlManager.createListBox("fontsizeselect", {
                title: "advanced.font_size", onselect: function (i) {
        ...
        _createBlockFormats: function () {
            ...
            k = j.editor.controlManager.createListBox("formatselect", {
                title: "advanced.block", onselect: function (l) {
        ...
        _mceColorPicker: function (k, j) {
            ...
            i.windowManager.open({
                ...
                inline: true
            }, {input_color: j.color, func: j.func, theme_url: this.url})
        },
        ...
        _mceForeColor: function () {
            ...
            this._mceColorPicker(0, {
                color: i.fgColor, func: function (j) {
                    i.fgColor = j;
        ...
        _mceBackColor: function () {
            var i = this;
            this._mceColorPicker(0, {
                color: i.bgColor, func: function (j) {
                    i.bgColor = j;
